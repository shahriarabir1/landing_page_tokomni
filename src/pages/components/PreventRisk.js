...
export default function PreventRisk() {
    useEffect(() => {
        ...
        .to("#prevent-background", {
          ...
          ease: "none",
        }, 0); // Start this animation at the same time as the background
  ...
  return (
    ...
    >
      ...
      <div className="z-10 text-center p-8">
        ...
        منع المخاطر من أن تصبح تهديدات
        </h1>
        <p className="mt-4 text-gray-600 max-w-2xl mx-auto text-lg">
        تخلق تطبيقات البرمجيات كخدمة (SaaS) العديد من المخاطر الخفية التي يمكن للقراصنة التسلل إليها. بينما يتحمل كل مزود خدمة مسؤولية تأمين بنيته التحتية، أنت مسؤول عن تنفيذ ضوابط الأمان عبر نظامك البيئي.
        </p>
      </div>
